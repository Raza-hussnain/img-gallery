...
function App() {
  return (
    ...
    {/* <div className="p-2 flex gap-1 flex-wrap justify-between"> */}
      ...
      <img
        className="h-[200px] mx-auto w-full object-cover"
      ...
      />
      <img
        className="h-[200px] mx-auto w-full object-cover col-span-2"
      ...
      />
      <img
        className="h-full mx-auto w-full object-cover row-span-2 "
