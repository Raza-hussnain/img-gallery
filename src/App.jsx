...
function App() {
  return (
    <div className="p-2 grid grid-cols-8 gap-2 h-screen grid-rows-6">
    {/* <div className="p-2 flex gap-1 flex-wrap justify-between"> */}

      <img
        className="h-full mx-auto w-full object-cover col-span-2 row-span-2 rounded-4xl "
      ...
      />
      <img
        className="h-full mx-auto w-full object-cover rounded-4xl"
      ...
      />
      <img
        className="h-full mx-auto w-full object-cover row-span-3 col-span-2 rounded-3xl "
      ...
      />
      <img
        className="h-full mx-auto w-full object-cover row-span-3 rounded-2xl"
      ...
      />
      <img
        className="h-full mx-auto w-full object-cover col-span-3 row-span-3 rounded-4xl"
      ...
      />
      <img
        className="h-full mx-auto w-full object-cover col-span-2 rounded-3xl row-span-2"
      ...
      />
      <img
        className="h-full mx-auto w-full object-cover  row-span-3 rounded-3xl"
      ...
      />
      <img
        className="h-full mx-auto w-full object-cover col-span-2 rounded-3xl row-span-3 "
      ...
      />
      <img
        className="h-full mx-auto w-full object-cover col-span-2 row-span-2 rounded-3xl"
      ...
      />
      <img
        className="h-full mx-auto w-full object-cover col-span-3 row-span-2 rounded-3xl"
      ...
      <img
        ...
        alt=""
      />
      <img className="h-full"src="https://images.unsplash.com/photo-1734117928667-c7f943a27e80?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8NDF8fHxlbnwwfHx8fHw%3D" alt="" /> */}
    </div>
  );
}
